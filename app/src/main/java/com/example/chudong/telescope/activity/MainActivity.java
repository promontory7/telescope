...
import com.example.chudong.telescope.db.UserDao;
import com.example.chudong.telescope.domain.InviteMessage;
import com.example.chudong.telescope.domain.InviteMessage.InviteMesageStatus;
import com.example.chudong.telescope.domain.User;
import com.example.chudong.telescope.utils.CommonUtils;
...
public class MainActivity extends BaseActivity implements EMEventListener {
    ...
    private FallingNetFragment fallingNetsFragment;
    private OceanFramgent oceansFragment;
...
//		MobclickAgent.updateOnlineConfig(this);
        ...
        fallingNetsFragment = new FallingNetFragment();
        oceansFragment = new OceanFramgent();

        fragments = new Fragment[]{chatHistoryFragment, contactListFragment, fallingNetsFragment, oceansFragment};
        // 添加显示第一个fragment
    ...
    private SlidingMenu initSlidingMenu(MainActivity activity) {
        ...
        localSlidingMenu.setShadowWidthRes(R.dimen.shawdow_width);
        localSlidingMenu.setShadowDrawable(R.drawable.shadow_left);
        localSlidingMenu.setSecondaryShadowDrawable(R.drawable.shadow_righ);
        ...
        localSlidingMenu.setMenu(R.layout.letf_menu_layout);
        getSupportFragmentManager().beginTransaction().replace(R.id.left_menu, new Left_Main_Layout()).commit();

        localSlidingMenu.setSecondaryMenu(R.layout.right_menu_layout);
        getSupportFragmentManager().beginTransaction().replace(R.id.right_menu, new SettingsFragment()).commit();
...
//        		userlist.put(Constant.CHAT_ROBOT, robotUser);
    ...
    private void initView() {
        ...
        mTabs[2] = (Button) findViewById(R.id.btn_sawang);
        mTabs[3] = (Button) findViewById(R.id.btn_ocean);
        ...
        toolbar_new = (ImageView) findViewById(R.id.toolbar_new);
        toolbar_new.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        toolbar_home = (ImageView) findViewById(R.id.toolbar_home);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (ChatActivity.activityInstance != null
                        ...
                        Toast.makeText(MainActivity.this, ChatActivity.activityInstance.getToChatUsername() + st10, Toast.LENGTH_SHORT).show();
