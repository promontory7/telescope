...
public class ChatAllHistoryAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.row_chat_history_layout, parent, false);
        }
        ...
        if (holder == null) {
            ...
            holder.image_first_rope = (ImageView) convertView.findViewById(R.id.first_rope_view);
            holder.image_next_rope = (ImageView) convertView.findViewById(R.id.next_rope_view);
        ...
        //	}\
        if (position == 0) {
            holder.image_first_rope.setVisibility(View.VISIBLE);
        } else {
            holder.image_first_rope.setVisibility(View.GONE);
        }


        if (position == (count - 1)) {
            holder.image_next_rope.setVisibility(View.GONE);
        } else {
            holder.image_next_rope.setVisibility(View.VISIBLE);
        }
    ...
    private static class ViewHolder {
        ...
        ImageView image_first_rope;
        ImageView image_next_rope;
